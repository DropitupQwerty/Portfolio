...
export const NavigationBar = () => {
	...
	return (
		<div className='fixed flex top-0 justify-between w-full z-[99999999] '>
			...
			<nav className={`flex justify-between items-center w-full p-[.7%] transition-all duration-300 bg-primary-white dark:bg-[#333] ${colorChange ? '  bg-opacity-100 shadow-md ' : 'bg-opacity-0'}`}>

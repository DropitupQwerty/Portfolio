...
export const Header = () => {
  ...
  return (
    <div
      id="home"
      ref={container}
      className="min-h-[80vh] lg:min-h-screen  max-w-screen overflow-hidden container mx-auto gap-10  relative  flex flex-col justify-center items-center z-10 "
    >
      ...
      <div className="">
        <div>
          <div className="overflow h-fit">
            <div className="uppercase text-7xl text-center  font-poppins  lg:text-8xl lg:flex   font-black  leading-none ">
              ...
              <motion.div>
                <span className="text-primary-orange tracking-widest ">
                  Valderama
                </span>
              </motion.div>
            </div>
          ...
          <motion.div className="flex justify-center  relative ">
            <p className=" text-4xl text-center lg:text-6xl leading-none font-DotGothic  whitespace-nowrap text-primary-black  font-black tracking-wide uppercase  dark:text-primary-white flex gap-4 flex-col md:flex-row">
              YOUR ASPIRING
              <div className="relative">
                {" "}
                <span className="text-primary-orange after:duration-300 after:bg-white after:dark:bg-[#333] after:animate-typing after:absolute after:h-full after:w-full after:border-l-4 after:left-0 after:border-primary-orange">
        ...
        <div className="mt-14 flex flex-col  gap-4 text-center">
          <a
            href="https://drive.google.com/file/d/1-IsEFs9YRUdpwBJiKv9RH52n0U13fhB9/view"
            target="_blank"
            className="tracking-[8px]  text-primary-orange  text-[2.4vh] font-poppins uppercase hover:underline "
            rel="noreferrer"
          >
            VIEW RESUME
          </a>

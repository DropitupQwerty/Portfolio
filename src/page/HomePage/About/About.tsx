				...
				<AnimationUpFade>
					<div className=' h-full z-10  rounded-xl flex flex-col lg:flex-row items-center justify-between relative w-full ' >
						...
						<div className='font-poppins text-justify w-[80%] lg:w-[40%]'>
							<div className='text-5xl tracking-widest font-bold '><span className="text-primary-orange">WHO AM I?</span> </div>
							<div className='indent-10 leading-relaxed text-4xl  dark:text-primary-white'>

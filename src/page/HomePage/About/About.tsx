				...
				<div className=' h-full  rounded-xl flex items-center justify-between relative p-[5%] w-full ' >
					...
					<div className='gap-10 flex flex-col'>
						{MySocmed.map((social , index)=>
							<div key={index} className='text-[5vh]'>
								{social.icon}
					...
					<div>
						<div className='rounded-full  max-h-[60vh] w-[60vh] overflow-hidden '>
							<img className='h-[250%] w-full object-cover' src={myImage}/>
						</div>
					</div>

					<div className=' text-[3vh] text-justify w-1/2 indent-10'>
						<p className=' leading-1  font-DotGothic'>Hello! I am a fresh graduate student that aspires to be a skilled web developer , capable of creating user-friendly online apps, knowledgable in<span className='dark:text-primary-blue text-primary-orange font-bold'> Java, JavaScript, TypeScript</span>, and informed about

...
export const ProjectCard = ({index , project} : ProjectCardProps) => {
	...
	return (
		<motion.div ref={container} className='flex flex-col justify-center min-h-screen '>
			...
			<div   className='container mx-auto '>
				...
				<div className='h-[50vh]   flex my-[5%] justify-center w-full '>
					...
					<div className=' w-full flex flex-col justify-between '>
						...
						<motion.div  style={{y:imageY}}  className='text-4xl leading-relaxed p-5 font-DotGothic max-h-[40vh] scroll-smooth   overflow-y-auto text-primary-black dark:text-primary-white text-justify  indent-[50px]'>
							{project.description}
						</motion.div>
